import "../App.css";
function ApplyingToColleges() {
  return (
    <div className="ApplyingToColleges">
      <img className="page_header" src={"/media/applying_to_colleges.png"} alt="" />
      <h1 style={{ marginTop: 50 }}>Applying to Colleges</h1>
...
export default ApplyingToColleges;