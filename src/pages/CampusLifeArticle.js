import "../App.css";
function CampusLifeArticle() {
    return (
        <div className="CampusLifeArticle">
            <img className="page_header" src={"/media/campus_life_article_header.png"} alt="" />
            <h1 style={{ marginTop: 50 }}>Why Campus Life Matters</h1>
...
export default CampusLifeArticle;