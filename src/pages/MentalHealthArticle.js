...
function MentalHealthArticle() {
    return (
        <div className="MentalHealthArticle">
            <img className="page_header" src={"/media/mental_health_article_header.png"} alt="" />
            <h1 style={{ marginTop: 50 }}>Mental Health Awareness in the Age of COVID and Zoom</h1>
