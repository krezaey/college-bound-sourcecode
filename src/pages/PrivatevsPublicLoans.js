import "../App.css";
function PrivatevsPublicLoans() {
  return (
    <div className="PrivatevsPublicLoans">
      <img className="page_header" src={"/media/private_vs_public_loans.png"} alt="" />
      <h1 style={{ marginTop: 50 }}>Private vs Public Loans</h1>
...
export default PrivatevsPublicLoans;