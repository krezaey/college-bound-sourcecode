import "../App.css";
function ScholarshipsBySchool() {
  return (
    <div className="ScholarshipsBySchool">
      <img className="page_header" src={"/media/scholarships_by_school.png"} alt="" />
      <h1 style={{ marginTop: 50 }}>Scholarships By School</h1>
...
export default ScholarshipsBySchool;